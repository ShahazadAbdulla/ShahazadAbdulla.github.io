...
I thrive on research-driven development, as demonstrated during my internship at **CSIR-NAL**, where I designed a sensor fusion system that reduced UGV trajectory error by over **90%** and authored a comprehensive **54-page** technical report. At **Intel**, I engineered an AI-driven quality control pipeline achieving **100% precision**. I am also an active open-source contributor, recognized as a **Top 3 global contributor** to a major ROS 2 release testing, and I actively maintain packages like `ros2_control`.
